...
// Shim: toTrianglesDrawMode may not be in core Three.js; provide identity fallback
if (!THREE.toTrianglesDrawMode) {
    THREE.toTrianglesDrawMode = function(geometry) { return geometry; };
}
const { toTrianglesDrawMode } = THREE;
